...
// Metade dependente de WinForms de WeaponAccessory, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Equipment/WeaponAccessory.cs.
//
// As duas são `partial class WeaponAccessory`: no projeto legado voltam a ser uma classe
...
{
    public partial class WeaponAccessory
    {
