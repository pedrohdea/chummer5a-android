...
// Metade dependente de WinForms de Metamagic, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Uniques/Metamagic.cs.
//
// As duas são `partial class Metamagic`: no projeto legado voltam a ser uma classe
