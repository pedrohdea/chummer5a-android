...
// Metade dependente de WinForms de MartialArt, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Uniques/MartialArt.cs.
//
// As duas são `partial class MartialArt`: no projeto legado voltam a ser uma classe
...
namespace Chummer
{
    public partial class MartialArt
    {
