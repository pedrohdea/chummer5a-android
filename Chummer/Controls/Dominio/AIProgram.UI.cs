...
// Metade dependente de WinForms de AIProgram, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Uniques/AIProgram.cs.
//
// As duas são `partial class AIProgram`: no projeto legado voltam a ser uma classe
