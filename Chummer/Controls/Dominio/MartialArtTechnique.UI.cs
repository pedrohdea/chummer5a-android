...
// Metade dependente de WinForms de MartialArtTechnique, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Uniques/MartialArtTechnique.cs.
//
// As duas são `partial class MartialArtTechnique`: no projeto legado voltam a ser uma classe
...
namespace Chummer
{
    public partial class MartialArtTechnique
    {
