...
// Metade dependente de WinForms de CritterPower, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Uniques/CritterPower.cs.
//
// As duas são `partial class CritterPower`: no projeto legado voltam a ser uma classe
...
namespace Chummer
{
    public partial class CritterPower
    {
