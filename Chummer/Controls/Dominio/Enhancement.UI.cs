...
// Metade dependente de WinForms de Enhancement, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Uniques/Enhancement.cs.
//
// As duas são `partial class Enhancement`: no projeto legado voltam a ser uma classe
