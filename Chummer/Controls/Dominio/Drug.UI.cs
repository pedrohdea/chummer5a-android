...
// Metade dependente de WinForms de Drug, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Equipment/Drugs.cs.
//
// As duas são `partial class Drug`: no projeto legado voltam a ser uma classe
