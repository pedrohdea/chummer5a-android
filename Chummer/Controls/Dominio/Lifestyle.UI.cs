...
// Metade dependente de WinForms de Lifestyle, separada do domínio durante a
// extração do núcleo (DEC-023). A metade de regras vive em Chummer/Backend/Equipment/Lifestyle.cs.
//
// As duas são `partial class Lifestyle`: no projeto legado voltam a ser uma classe
